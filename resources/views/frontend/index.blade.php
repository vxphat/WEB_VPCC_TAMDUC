...
@section('clientContent')
    ...
    {{-- <div class="banner text-center">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9 mx-auto">
                    <h1 class="mb-5">Xem gì hôm nay? </h1>
                    <h2 class="mb-5">Cập nhật thông tin mới nhất</h2>
                    <ul class="list-inline widget-list-inline">
                        @foreach ($postCatalogues as $postCatalogue)
                            <li class="list-inline-item"><a
                                    href="{{ $postCatalogue->canonical }}">{{ $postCatalogue->name }}</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mb-5">
                    ...
                    <article class="card">
                        <div class="post-slider slider-sm">
                            <img src="frontend/images/post/post-1.jpg" class="card-img-top" alt="post-thumb">
                        </div>
                            ...
                            <ul class="card-meta list-inline">
                                <li class="list-inline-item">
                                    <a href="author-single.html" class="card-meta-author">
                                        <img src="frontend/images/john-doe.jpg">
                ...
                <div class="col-lg-4 mb-5">
                    ...
                    <article class="card mb-4">
                        <div class="card-body d-flex">
                            <img class="card-img-sm" src="frontend/images/post/post-2.jpg">
                            <div class="ml-3">
                    ...
                    <article class="card mb-4">
                        <div class="card-body d-flex">
                            <img class="card-img-sm" src="frontend/images/post/post-4.jpg">
                            <div class="ml-3">
                ...
                <div class="col-lg-4 mb-5">
                    ...
                    <article class="card">
                        <div class="post-slider slider-sm">
                            <img src="frontend/images/post/post-5.jpg" class="card-img-top" alt="post-thumb">
                        </div>
                        <div class="card-body">
                            ...
                            <ul class="card-meta list-inline">
                                <li class="list-inline-item">
                                    <a href="author-single.html" class="card-meta-author">
                                        <img src="frontend/images/kate-stone.jpg" alt="Kate Stone">
